...
class postgresql(
                  ...
                  $initdb                          = true,
                  $overcommit_memory               = '2',
                  $shmmax                          = ceiling(Integer($facts['memory']['total_bytes'])*824633720832),
                  $shmall                          = ceiling(Integer($facts['memory']['total_bytes'])*824633720832/$facts['eyp_postgresql_pagesize']),
                  ...
                  $wal_buffers                     = '-1',
                  $work_mem                        = '8MB',
                  $shared_buffers                  = sprintf('%dMB',ceiling(sprintf('%d', $facts['memory']['total_bytes'])*262144)),
                  $lc_messages                     = 'C',
                  ...
                  $effective_cache_size            = sprintf('%dMB',ceiling(sprintf('%d', ($facts['memory']['total_bytes'])*262144)*3)),
                  ...
                  $max_parallel_workers_per_gather = max(2, ceiling(sprintf('%d', ($facts['processors']['count'])/2))),
                  $hot_standby                     = false,
